...
// Function that removes trailing newline character from each line in socket ("line" variable) as a result of the fgets()
...
// Function that gets command from socket (assign the command and its argument(s) as element(s) of the command array)
void getCommandFromLine(char *line, char *command[BUFFER_SIZE], int *argumentCounter) {
  ...
  char tmpLine[BUFFER_SIZE]; // Temporary variable that also holds the selected line in socket ("line" variable)
  char *token; // Represent each substring of the selected line in socket ("line" variable) delimited/separated by " "

  // Copy the content of the selected line in socket ("line" variable) to the temporary variable ("tmpLine" variable)
  ...
  // Get a substring of the selected line in socket delimited/separated by " "
...
// Function that executes command from socket
